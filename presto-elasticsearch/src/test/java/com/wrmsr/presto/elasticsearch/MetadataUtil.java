...
public final class MetadataUtil
{
    ...
    public static final JsonCodec<Map<String, List<ElasticsearchTable>>> CATALOG_CODEC;
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(ElasticsearchTable.class));
