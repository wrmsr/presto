...
public class TestElasticsearchRecordSet
{
            ...
            throws Exception
    {
        RecordSet recordSet = new ElasticsearchRecordSet(new ElasticsearchSplit("test", "schema", "table", dataUri), ImmutableList.of(
                new ElasticsearchColumnHandle("test", "text", VARCHAR, 0),
        ...
        recordSet = new ElasticsearchRecordSet(new ElasticsearchSplit("test", "schema", "table", dataUri), ImmutableList.<ElasticsearchColumnHandle>of());
