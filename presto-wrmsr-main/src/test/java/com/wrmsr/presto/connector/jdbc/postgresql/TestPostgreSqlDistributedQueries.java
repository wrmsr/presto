...
import static com.wrmsr.presto.connector.jdbc.postgresql.PostgreSqlQueryRunner.createPostgreSqlQueryRunner;
        ...
        extends AbstractTestQueries
{
    ...
    public void testDropTable()
            throws Exception
    {
        assertUpdate("CREATE TABLE test_drop AS SELECT 123 x");
