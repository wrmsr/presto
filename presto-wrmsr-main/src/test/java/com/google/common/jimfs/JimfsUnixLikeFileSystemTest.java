...
public class JimfsUnixLikeFileSystemTest
        extends AbstractJimfsIntegrationTest
{
    ...
    @Test
    public void testPaths_toRealPath()
            throws IOException
    {
    ...
    @Test
    public void testNewFileSystem_hasRootAndWorkingDirectory()
            throws IOException
    {
    ...
    @Test
    public void testCreateDirectory_absolute()
            throws IOException
    {
    ...
    @Test
    public void testCreateFile_absolute()
            throws IOException
    {
    ...
    @Test
    public void testCreateSymbolicLink_absolute()
            throws IOException
    {
    ...
    @Test
    public void testCreateLink_absolute()
            throws IOException
    {
        Files.createFile(path("/test.txt"));
    ...
    @Test
    public void testCreateDirectory_relative()
            throws IOException
    {
        Files.createDirectory(path("test"));
    ...
    @Test
    public void testCreateFile_relative()
            throws IOException
    {
        Files.createFile(path("test.txt"));
    ...
    @Test
    public void testCreateSymbolicLink_relative()
            throws IOException
    {
        Files.createSymbolicLink(path("link.txt"), path("test.txt"));
    ...
    @Test
    public void testCreateLink_relative()
            throws IOException
    {
        Files.createFile(path("test.txt"));
        Files.createLink(path("link.txt"), path("test.txt"));
    ...
    @Test
    public void testCreateFile_existing()
            throws IOException
    {
    ...
    @Test
    public void testCreateFile_parentDoesNotExist()
            throws IOException
    {
        try {
    ...
    @Test
    public void testCreateFile_parentIsNotDirectory()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
    ...
    @Test
    public void testCreateFile_nonDirectoryHigherInPath()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
        Files.createFile(path("/foo/bar"));
    ...
    @Test
    public void testCreateFile_parentSymlinkDoesNotExist()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
    ...
    @Test
    public void testCreateFile_symlinkHigherInPathDoesNotExist()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
    ...
    @Test
    public void testCreateFile_parentSymlinkDoesPointsToNonDirectory()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
    ...
    @Test
    public void testCreateFile_symlinkHigherInPathPointsToNonDirectory()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
        Files.createFile(path("/foo/file"));
    ...
    @Test
    public void testCreateFile_withInitialAttributes()
            throws IOException
    {
    ...
    @Test
    public void testCreateFile_withInitialAttributes_illegalInitialAttribute()
            throws IOException
    {
        try {
            Files.createFile(
    ...
    @Test
    public void testOpenChannel_withInitialAttributes_createNewFile()
            throws IOException
    {
    ...
    @Test
    public void testOpenChannel_withInitialAttributes_fileExists()
            throws IOException
    {
        Files.createFile(path("/foo"));
    ...
    @Test
    public void testCreateDirectory_withInitialAttributes()
            throws IOException
    {
        FileAttribute<Set<PosixFilePermission>> permissions =
                PosixFilePermissions.asFileAttribute(PosixFilePermissions.fromString("rwxrwxrwx"));
    ...
    @Test
    public void testCreateSymbolicLink_withInitialAttributes()
            throws IOException
    {
        FileAttribute<Set<PosixFilePermission>> permissions =
                PosixFilePermissions.asFileAttribute(PosixFilePermissions.fromString("rwxrwxrwx"));
    ...
    @Test
    public void testDirectories_newlyCreatedDirectoryHasTwoLinks()
            throws IOException
    {
    ...
    @Test
    public void testDirectories_creatingDirectoryAddsOneLinkToParent()
            throws IOException
    {
        // from the .. direntry
    ...
    @Test
    public void testDirectories_creatingNonDirectoryDoesNotAddLinkToParent()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
        Files.createFile(path("/foo/file"));
    ...
    @Test
    public void testSize_forNewFile_isZero()
            throws IOException
    {
        Files.createFile(path("/test"));
    ...
    @Test
    public void testRead_forNewFile_isEmpty()
            throws IOException
    {
        Files.createFile(path("/test"));
    ...
    @Test
    public void testWriteFile_succeeds()
            throws IOException
    {
        Files.createFile(path("/test"));
    ...
    @Test
    public void testSize_forFileAfterWrite_isNumberOfBytesWritten()
            throws IOException
    {
        Files.write(path("/test"), new byte[] {0, 1, 2, 3});
    ...
    @Test
    public void testRead_forFileAfterWrite_isBytesWritten()
            throws IOException
    {
        byte[] bytes = {0, 1, 2, 3};
    ...
    @Test
    public void testWriteFile_withStandardOptions()
            throws IOException
    {
        Path test = path("/test");
        byte[] bytes = {0, 1, 2, 3};
    ...
    @Test
    public void testWriteLines_succeeds()
            throws IOException
    {
    ...
    @Test
    public void testOpenFile_withReadAndTruncateExisting_doesNotTruncateFile()
            throws IOException
    {
    ...
    @Test
    public void testRead_forFileAfterWriteLines_isLinesWritten()
            throws IOException
    {
        Files.write(path("/test.txt"), ImmutableList.of("hello", "world"), UTF_8);
    ...
    @Test
    public void testWriteLines_withStandardOptions()
            throws IOException
    {
    ...
    @Test
    public void testWrite_fileExistsButIsNotRegularFile()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
    ...
    @Test
    public void testDelete_file_whenOpenReferencesRemain()
            throws IOException
    {
    ...
    @Test
    public void testDelete_directory()
            throws IOException
    {
        Files.createDirectories(path("/foo/bar"));
        assertThatPath("/foo").isDirectory();
    ...
    @Test
    public void testDelete_pathPermutations()
            throws IOException
    {
    ...
    @Test
    public void testDelete_directory_cantDeleteNonEmptyDirectory()
            throws IOException
    {
        Files.createDirectories(path("/foo/bar"));
    ...
    @Test
    public void testDelete_directory_canDeleteWorkingDirectoryByAbsolutePath()
            throws IOException
    {
    ...
    @Test
    public void testDelete_directory_cantDeleteWorkingDirectoryByRelativePath()
            throws IOException
    {
        try {
            Files.delete(path(""));
    ...
    @Test
    public void testDelete_directory_cantDeleteRoot()
            throws IOException
    {
    ...
    @Test
    public void testSymbolicLinks_symlinkCycle()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
    ...
    @Test
    public void testSymbolicLinks_lookupOfAbsoluteSymlinkPathFromRelativePath()
            throws IOException
    {
    ...
    @Test
    public void testLink_forSymbolicLink_usesSymbolicLinkTarget()
            throws IOException
    {
    ...
    @Test
    public void testLink_failsWhenTargetDoesNotExist()
            throws IOException
    {
        try {
    ...
    @Test
    public void testLinks_failsWhenTargetFileAlreadyExists()
            throws IOException
    {
        Files.createFile(path("/file"));
    ...
    @Test
    public void testCopy_inputStreamToFile()
            throws IOException
    {
    ...
    @Test
    public void testCopy_fileToPath()
            throws IOException
    {
        byte[] bytes = preFilledBytes(512);
    ...
    @Test
    public void testCopy_withCopyAttributes()
            throws IOException
    {
        Path foo = path("/foo");
    ...
    @Test
    public void testCopy_doesNotSupportAtomicMove()
            throws IOException
    {
        try {
    ...
    @Test
    public void testCopy_directoryToPath()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
    ...
    @Test
    public void testCopy_withoutReplaceExisting_failsWhenTargetExists()
            throws IOException
    {
        Files.createFile(path("/bar"));
        Files.createDirectory(path("/foo"));
    ...
    @Test
    public void testCopy_withReplaceExisting()
            throws IOException
    {
        Files.createFile(path("/bar"));
        Files.createDirectory(path("/test"));
    ...
    @Test
    public void testCopy_withReplaceExisting_cantReplaceNonEmptyDirectory()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
        Files.createDirectory(path("/foo/bar"));
    ...
    @Test
    public void testCopy_directoryToPath_doesNotCopyDirectoryContents()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
        Files.createDirectory(path("/foo/baz"));
    ...
    @Test
    public void testCopy_symbolicLinkToPath()
            throws IOException
    {
    ...
    @Test
    public void testCopy_toDifferentFileSystem()
            throws IOException
    {
    ...
    @Test
    public void testCopy_toDifferentFileSystem_copyAttributes()
            throws IOException
    {
        try (FileSystem fs2 = Jimfs.newFileSystem(UNIX_CONFIGURATION)) {
            Path foo = fs.getPath("/foo");
    ...
    @Test
    public void testMove_movesSymbolicLinkNotTarget()
            throws IOException
    {
        byte[] bytes = preFilledBytes(100);
    ...
    @Test
    public void testMove_cannotMoveDirIntoOwnSubtree()
            throws IOException
    {
    ...
    @Test
    public void testMove_withoutReplaceExisting_failsWhenTargetExists()
            throws IOException
    {
    ...
    @Test
    public void testMove_toDifferentFileSystem()
            throws IOException
    {
    ...
    @Test
    public void testIsSameFile_forPathFromDifferentFileSystemProvider()
            throws IOException
    {
    ...
    @Test
    public void testSecureDirectoryStream()
            throws IOException
    {
        Files.createDirectories(path("/foo/bar"));
    ...
    @Test
    public void testSecureDirectoryStreamBasedOnRelativePath()
            throws IOException
    {
        Files.createDirectories(path("foo"));
        Files.createFile(path("foo/a"));
    ...
    @Test
    public void testClosedSecureDirectoryStream()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
    ...
    @Test
    public void testClosedSecureDirectoryStreamAttributeViewAndIterator()
            throws IOException
    {
        Files.createDirectory(path("/foo"));
        Files.createDirectory(path("/foo/bar"));
    ...
    @Test
    public void testDirectoryAccessAndModifiedTimeUpdates()
            throws IOException
    {
        Files.createDirectories(path("/foo/bar"));
    ...
    @Test
    public void testRegularFileAccessAndModifiedTimeUpdates()
            throws IOException
    {
        Path foo = path("foo");
        Files.createFile(foo);
