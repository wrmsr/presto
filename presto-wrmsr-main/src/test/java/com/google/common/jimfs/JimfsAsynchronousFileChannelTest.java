...
public class JimfsAsynchronousFileChannelTest
{
    ...
    private static JimfsAsynchronousFileChannel channel(
            RegularFile file, ExecutorService executor, OpenOption... options)
            throws IOException
    {
    ...
    @Test
    public void testAsyncClose_write()
            throws IOException, InterruptedException
    {
        RegularFile file = regularFile(15);
    ...
    @Test
    public void testAsyncClose_read()
            throws IOException, InterruptedException
    {
        RegularFile file = regularFile(15);
    ...
    private static void checkAsyncRead(AsynchronousFileChannel channel)
            throws Throwable
    {
    ...
    private static void checkAsyncWrite(AsynchronousFileChannel asyncChannel)
            throws Throwable
    {
        ByteBuffer buf = buffer("1234567890");
    ...
    private static void checkAsyncLock(AsynchronousFileChannel channel)
            throws Throwable
    {
    ...
    private static void assertClosed(Future<?> future)
