...
public class FileSystemStateTest
{
    ...
    @Test
    public void testClose_callsOnCloseRunnable()
            throws IOException
    {
    ...
    @Test
    public void testClose_multipleTimesDoNothing()
            throws IOException
    {
        state.close();
        assertEquals(1, onClose.runCount);
    ...
    @Test
    public void testClose_registeredResourceIsClosed()
            throws IOException
    {
    ...
    @Test
    public void testClose_unregisteredResourceIsNotClosed()
            throws IOException
    {
        TestCloseable resource = new TestCloseable();
        state.register(resource);
    ...
    @Test
    public void testClose_multipleRegisteredResourcesAreClosed()
            throws IOException
    {
    ...
    private static class ThrowsOnClose
            extends TestCloseable
    {
