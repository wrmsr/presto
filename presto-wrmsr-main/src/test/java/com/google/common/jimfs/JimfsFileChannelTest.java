...
public class JimfsFileChannelTest
{
    ...
    @Test
    public void testWritesInReadOnlyMode()
            throws IOException
    {
    ...
    @Test
    public void testTransferFromNegative()
            throws IOException
    {
        FileChannel channel = channel(regularFile(0), READ, WRITE);
    ...
    @Test
    public void testAsynchronousClose()
            throws Exception
    {
        RegularFile file = regularFile(10);
    ...
    @Test
    public void testCloseByInterrupt()
            throws Exception
    {
        RegularFile file = regularFile(10);
        final FileChannel channel = channel(file, READ, WRITE);
     ...
     * longer interrupted.
     */
    private static void assertClosedByInterrupt(FileChannelMethod method)
            throws IOException
    {
        FileChannel channel = channel(regularFile(10), READ, WRITE);
