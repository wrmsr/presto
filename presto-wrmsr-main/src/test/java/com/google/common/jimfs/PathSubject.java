        ...
        extends Subject<PathSubject, Path>
{
     ...
     */
    public PathSubject withTarget(String targetPath)
            throws IOException
    {
     ...
     */
    public PathSubject hasLinkCount(int count)
            throws IOException
    {
        exists();
     ...
     */
    public PathSubject isSameFileAs(String path)
            throws IOException
    {
     ...
     * Asserts that the path resolves to the same file as the given path.
     */
    public PathSubject isSameFileAs(Path path)
            throws IOException
    {
     ...
     */
    public PathSubject isNotSameFileAs(String path)
            throws IOException
    {
     ...
     */
    public PathSubject hasNoChildren()
            throws IOException
    {
        isDirectory();
     ...
     */
    public PathSubject hasChildren(String... children)
            throws IOException
    {
        isDirectory();
     ...
     */
    public PathSubject hasSize(long size)
            throws IOException
    {
     ...
     */
    public PathSubject containsNoBytes()
            throws IOException
    {
     ...
     */
    public PathSubject containsBytes(int... bytes)
            throws IOException
    {
     ...
     */
    public PathSubject containsBytes(byte[] bytes)
            throws IOException
    {
        isRegularFile();
     ...
     * given path.
     */
    public PathSubject containsSameBytesAs(String path)
            throws IOException
    {
        isRegularFile();
     ...
     */
    public PathSubject containsLines(String... lines)
            throws IOException
    {
     ...
     * bytes are decoded as UTF-8; for a different charset, use {@link #withCharset(Charset)}.
     */
    public PathSubject containsLines(Iterable<String> lines)
            throws IOException
    {
        isRegularFile();
    ...
    public Attribute attribute(final String attribute)
    {
        ...
        {
            @Override
            public Attribute is(Object value)
                    throws IOException
            {
            ...
            @Override
            public Attribute isNot(Object value)
                    throws IOException
            {
                Object actualValue = Files.getAttribute(getSubject(), attribute, linkOptions);
                if (Objects.equals(value, actualValue)) {
    ...
    private static class PathSubjectFactory
            extends SubjectFactory<PathSubject, Path>
    {
