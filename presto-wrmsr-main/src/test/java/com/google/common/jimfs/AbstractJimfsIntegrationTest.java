...
public abstract class AbstractJimfsIntegrationTest
{
    ...
    protected Object getFileKey(String path, LinkOption... options)
            throws IOException
    {
    ...
    protected static final class FileTimeTester
    {
        ...
        public void assertAccessTimeChanged()
                throws IOException
        {
        ...
        public void assertAccessTimeDidNotChange()
                throws IOException
        {
            FileTime t = attrs().lastAccessTime();
        ...
        public void assertModifiedTimeChanged()
                throws IOException
        {
        ...
        public void assertModifiedTimeDidNotChange()
                throws IOException
        {
            FileTime t = attrs().lastModifiedTime();
