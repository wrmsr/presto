...
public class JimfsInputStreamTest
{
    ...
    @Test
    public void testRead_wholeArray()
            throws IOException
    {
    ...
    @Test
    public void testRead_wholeArray_arrayLarger()
            throws IOException
    {
        JimfsInputStream in = newInputStream(1, 2, 3, 4, 5, 6, 7, 8);
    ...
    @Test
    public void testRead_wholeArray_arraySmaller()
            throws IOException
    {
        JimfsInputStream in = newInputStream(1, 2, 3, 4, 5, 6, 7, 8);
    ...
    @Test
    public void testRead_partialArray()
            throws IOException
    {
        JimfsInputStream in = newInputStream(1, 2, 3, 4, 5, 6, 7, 8);
        byte[] bytes = new byte[12];
    ...
    @Test
    public void testRead_partialArray_sliceLarger()
            throws IOException
    {
        JimfsInputStream in = newInputStream(1, 2, 3, 4, 5, 6, 7, 8);
        byte[] bytes = new byte[12];
    ...
    @Test
    public void testRead_partialArray_sliceSmaller()
            throws IOException
    {
        JimfsInputStream in = newInputStream(1, 2, 3, 4, 5, 6, 7, 8);
        byte[] bytes = new byte[12];
    ...
    @Test
    public void testRead_partialArray_invalidInput()
            throws IOException
    {
    ...
    @Test
    public void testFullyReadInputStream_doesNotChangeStateWhenStoreChanges()
            throws IOException
    {
        JimfsInputStream in = newInputStream(1, 2, 3, 4, 5);
    ...
    @Test
    public void testClosedInputStream_throwsException()
            throws IOException
    {
        JimfsInputStream in = newInputStream(1, 2, 3);
        in.close();
    ...
    private static void assertEmpty(JimfsInputStream in)
            throws IOException
    {
        assertThat(in.read()).isEqualTo(-1);
