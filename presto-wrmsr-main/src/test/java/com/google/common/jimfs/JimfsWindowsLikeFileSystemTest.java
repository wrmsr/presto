        ...
        extends AbstractJimfsIntegrationTest
{
    ...
    @Test
    public void testCreateFileOrDirectory_forNonExistentRootPath_fails()
            throws IOException
    {
        try {
    ...
    @Test
    public void testCopyFile_toNonExistentRootPath_fails()
            throws IOException
    {
    ...
    @Test
    public void testMoveFile_toNonExistentRootPath_fails()
            throws IOException
    {
        Files.createFile(path("foo"));
        Files.createDirectory(path("bar"));
    ...
    @Test
    public void testCreateFileOrDirectory_forExistingRootPath_fails()
            throws IOException
    {
        try {
    ...
    @Test
    public void testCopyFile_toExistingRootPath_fails()
            throws IOException
    {
        Files.createFile(path("foo"));
        Files.createDirectory(path("bar"));
    ...
    @Test
    public void testMoveFile_toExistingRootPath_fails()
            throws IOException
    {
        Files.createFile(path("foo"));
        Files.createDirectory(path("bar"));
    ...
    @Test
    public void testMove_rootDirectory_fails()
            throws IOException
    {
        try {
