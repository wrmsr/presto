...
public class JimfsOutputStreamTest
{
    ...
    @Test
    public void testWrite_singleByte()
            throws IOException
    {
    ...
    @Test
    public void testWrite_wholeArray()
            throws IOException
    {
        JimfsOutputStream out = newOutputStream(false);
    ...
    @Test
    public void testWrite_partialArray()
            throws IOException
    {
        JimfsOutputStream out = newOutputStream(false);
    ...
    @Test
    public void testWrite_partialArray_invalidInput()
            throws IOException
    {
        JimfsOutputStream out = newOutputStream(false);
    ...
    @Test
    public void testWrite_singleByte_appendMode()
            throws IOException
    {
    ...
    @Test
    public void testWrite_wholeArray_appendMode()
            throws IOException
    {
        JimfsOutputStream out = newOutputStream(true);
        addBytesToStore(out, 9, 8, 7);
    ...
    @Test
    public void testWrite_partialArray_appendMode()
            throws IOException
    {
        JimfsOutputStream out = newOutputStream(true);
        addBytesToStore(out, 9, 8, 7);
    ...
    @Test
    public void testWrite_singleByte_overwriting()
            throws IOException
    {
        JimfsOutputStream out = newOutputStream(false);
    ...
    @Test
    public void testWrite_wholeArray_overwriting()
            throws IOException
    {
        JimfsOutputStream out = newOutputStream(false);
        addBytesToStore(out, 9, 8, 7, 6, 5, 4, 3);
    ...
    @Test
    public void testWrite_partialArray_overwriting()
            throws IOException
    {
        JimfsOutputStream out = newOutputStream(false);
        addBytesToStore(out, 9, 8, 7, 6, 5, 4, 3);
    ...
    @Test
    public void testClosedOutputStream_throwsException()
            throws IOException
    {
        JimfsOutputStream out = newOutputStream(false);
        out.close();
    ...
    @Test
    public void testClosedOutputStream_doesNotThrowOnFlush()
            throws IOException
    {
        JimfsOutputStream out = newOutputStream(false);
        out.close();
