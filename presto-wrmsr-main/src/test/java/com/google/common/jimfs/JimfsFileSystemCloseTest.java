...
public class JimfsFileSystemCloseTest
{
    ...
    @Test
    public void testIsNotAvailableFromProvider()
            throws IOException
    {
        URI uri = fs.getUri();
    ...
    @Test
    public void testOpenStreamsClosed()
            throws IOException
    {
    ...
    @Test
    public void testOpenChannelsClosed()
            throws IOException
    {
        Path p = fs.getPath("/foo");
    ...
    @Test
    public void testOpenDirectoryStreamsClosed()
            throws IOException
    {
        Path p = fs.getPath("/foo");
    ...
    @Test
    public void testOpenWatchServicesClosed()
            throws IOException
    {
    ...
    @Test
    public void testPathMethodsThrow()
            throws IOException
    {
        Path p = fs.getPath("/foo");
        Files.createDirectory(p);
    ...
    @Test
    public void testOpenFileAttributeViewsThrow()
            throws IOException
    {
        Path p = fs.getPath("/foo");
        Files.createFile(p);
    ...
    @Test
    public void testFileSystemMethodsThrow()
            throws IOException
    {
        fs.close();
    ...
    @Test
    public void testFilesMethodsThrow()
            throws IOException
    {
