...
public class FileTreeTest
{
   ...
   */
    ...
    @Test
    public void testLookup_nonExistentRoot()
            throws IOException
    {
        try {
            lookup("!");
    ...
    @Test
    public void testLookup_absolute()
            throws IOException
    {
    ...
    @Test
    public void testLookup_absolute_notExists()
            throws IOException
    {
        try {
            lookup("/a/b");
    ...
    @Test
    public void testLookup_absolute_parentExists()
            throws IOException
    {
    ...
    @Test
    public void testLookup_absolute_nonDirectoryIntermediateFile()
            throws IOException
    {
        try {
    ...
    @Test
    public void testLookup_absolute_intermediateSymlink()
            throws IOException
    {
    ...
    @Test
    public void testLookup_absolute_intermediateSymlink_parentExists()
            throws IOException
    {
    ...
    @Test
    public void testLookup_absolute_finalSymlink()
            throws IOException
    {
    ...
    @Test
    public void testLookup_absolute_finalSymlink_nofollowLinks()
            throws IOException
    {
    ...
    @Test
    public void testLookup_absolute_withDotsInPath()
            throws IOException
    {
        assertExists(lookup("/."), "/", "/");
        assertExists(lookup("/./././."), "/", "/");
    ...
    @Test
    public void testLookup_absolute_withDotDotsInPath()
            throws IOException
    {
        assertExists(lookup("/.."), "/", "/");
        assertExists(lookup("/../../.."), "/", "/");
    ...
    @Test
    public void testLookup_absolute_withDotDotsInPath_afterSymlink()
            throws IOException
    {
    ...
    @Test
    public void testLookup_relative()
            throws IOException
    {
    ...
    @Test
    public void testLookup_relative_notExists()
            throws IOException
    {
        try {
            lookup("a/b");
    ...
    @Test
    public void testLookup_relative_parentExists()
            throws IOException
    {
    ...
    @Test
    public void testLookup_relative_nonDirectoryIntermediateFile()
            throws IOException
    {
        try {
    ...
    @Test
    public void testLookup_relative_intermediateSymlink()
            throws IOException
    {
    ...
    @Test
    public void testLookup_relative_intermediateSymlink_parentExists()
            throws IOException
    {
    ...
    @Test
    public void testLookup_relative_finalSymlink()
            throws IOException
    {
    ...
    @Test
    public void testLookup_relative_finalSymlink_nofollowLinks()
            throws IOException
    {
    ...
    @Test
    public void testLookup_relative_emptyPath()
            throws IOException
    {
        assertExists(lookup(""), "/", "work");
    }
    ...
    @Test
    public void testLookup_relative_withDotsInPath()
            throws IOException
    {
        assertExists(lookup("."), "/", "work");
        assertExists(lookup("././."), "/", "work");
    ...
    @Test
    public void testLookup_relative_withDotDotsInPath_afterSymlink()
            throws IOException
    {
    ...
    private DirectoryEntry lookup(String path, LinkOption... options)
            throws IOException
    {
