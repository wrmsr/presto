...
public class HeapDiskTest
{
    ...
    @Test
    public void testFree_noCaching()
            throws IOException
    {
        HeapDisk disk = new HeapDisk(4, 10, 0);
    ...
    @Test
    public void testFree_fullCaching()
            throws IOException
    {
    ...
    @Test
    public void testFree_partialCaching()
            throws IOException
    {
    ...
    @Test
    public void testAllocateFromCache_fullAllocationFromCache()
            throws IOException
    {
        HeapDisk disk = new HeapDisk(4, 10, 10);
    ...
    @Test
    public void testAllocateFromCache_partialAllocationFromCache()
            throws IOException
    {
        HeapDisk disk = new HeapDisk(4, 10, 4);
        disk.allocate(blocks, 10);
