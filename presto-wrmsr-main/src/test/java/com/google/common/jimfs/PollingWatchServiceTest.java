...
public class PollingWatchServiceTest
{
    ...
    @Test
    public void testRegister_fileDoesNotExist()
            throws IOException
    {
        try {
    ...
    @Test
    public void testRegister_fileIsNotDirectory()
            throws IOException
    {
    ...
    @Test
    public void testCancellingLastKeyStopsPolling()
            throws IOException
    {
        Key key = watcher.register(createDirectory(), ImmutableList.of(ENTRY_CREATE));
        key.cancel();
    ...
    @Test
    public void testCloseCancelsAllKeysAndStopsPolling()
            throws IOException
    {
    ...
    @Test(timeout = 2000)
    public void testWatchForOneEventType()
    ...
    @Test(timeout = 2000)
    public void testWatchForMultipleEventTypes()
            throws IOException, InterruptedException
    {
        JimfsPath path = createDirectory();
    ...
    private void assertWatcherHasEvents(WatchEvent<?>... events)
    ...
    private JimfsPath createDirectory()
            throws IOException
    {
