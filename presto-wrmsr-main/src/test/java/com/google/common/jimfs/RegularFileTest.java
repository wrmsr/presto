...
public class RegularFileTest
{
     ...
     */
    public static class RegularFileTestRunner
            extends TestCase
    {
        ...
        public void testEmpty_write_noBytesArray_atStart()
                throws IOException
        {
        ...
        public void testEmpty_write_noBytesArray_atNonZeroPosition()
                throws IOException
        {
        ...
        public void testEmpty_write_noBytesBuffer_atStart()
                throws IOException
        {
            file.write(0, buffer(""));
            assertContentEquals(bytes(), file);
        ...
        public void testEmpty_write_noBytesBuffer_atNonZeroPosition()
                throws IOException
        {
        ...
        public void testEmpty_write_noBytesBuffers_atStart()
                throws IOException
        {
        ...
        public void testEmpty_write_noBytesBuffers_atNonZeroPosition()
                throws IOException
        {
        ...
        public void testEmpty_transferFrom_fromStart_countEqualsSrcSize()
                throws IOException
        {
        ...
        public void testEmpty_transferFrom_fromBeyondStart_countEqualsSrcSize()
                throws IOException
        {
        ...
        public void testEmpty_transferFrom_fromBeyondStart_countLessThanSrcSize()
                throws IOException
        {
        ...
        public void testEmpty_transferTo()
                throws IOException
        {
        ...
        public void testNonEmpty_transferTo_fromStart_countEqualsSize()
                throws IOException
        {
            fillContent("123456");
        ...
        public void testNonEmpty_transferTo_fromStart_countLessThanSize()
                throws IOException
        {
            fillContent("123456");
            ByteBufferChannel channel = new ByteBufferChannel(10);
        ...
        public void testNonEmpty_transferTo_fromMiddle_countEqualsSize()
                throws IOException
        {
            fillContent("123456");
            ByteBufferChannel channel = new ByteBufferChannel(10);
        ...
        public void testNonEmpty_transferFrom_toEnd()
                throws IOException
        {
            fillContent("222222");
            ByteBufferChannel channel = new ByteBufferChannel(buffer("111111"));
        ...
        public void testNonEmpty_transferFrom_toPastEnd()
                throws IOException
        {
            fillContent("222222");
            ByteBufferChannel channel = new ByteBufferChannel(buffer("111111"));
        ...
        public void testNonEmpty_transferFrom_hugeOverestimateCount()
                throws IOException
        {
            fillContent("222222");
            ByteBufferChannel channel = new ByteBufferChannel(buffer("111111"));
