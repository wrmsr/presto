...
/**
 */
public final class SpyCache<K, V>
        extends AbstractCache<K, V>
{
     ...
     * @author Yannis Cosmadopoulos
     */
    private static class SpyCacheLoaderLoadCallable<K, V>
     ...
     * @author Yannis Cosmadopoulos
     */
    private static class SpyCacheLoaderLoadAllCallable<K, V>
     ...
     * @since 1.0
     */
    private static class SpyMutableEntry<K, V>
