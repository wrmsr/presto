...
public class ExtendedJdbcMetadataFactory
        extends JdbcMetadataFactory
{
    ...
    @Inject
    public ExtendedJdbcMetadataFactory(JdbcClient jdbcClient, JdbcMetadataConfig config)
    {
    ...
    {
        return new ExtendedJdbcMetadata(jdbcClient, allowDropTable);
    }
}
