...
public class MetaconnectorsConfig
        extends MapMergeableConfig<MetaconnectorsConfig, String, MetaconnectorsConfig.Entry>
        implements Config<MetaconnectorsConfig>
{
    ...
    @JsonCreator
    public MetaconnectorsConfig(Map<String, Entry> entries)
    {
        super(entries);
    }

    public MetaconnectorsConfig()
    {
    }
