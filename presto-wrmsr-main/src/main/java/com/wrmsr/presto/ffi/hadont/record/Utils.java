...
import com.wrmsr.presto.ffi.hadont.io.WritableUtils;
...
public class Utils
{
    ...
    private static int utf8LenForCodePoint(final int cpt)
            throws IOException
    {
        if (cpt >= 0 && cpt <= 0x7F) {
            return 1;
    ...
    static String fromBinaryString(final DataInput din)
            throws IOException
    {
