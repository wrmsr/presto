...
import com.wrmsr.presto.ffi.hadont.streaming.StreamKeyValUtil;
...
import com.wrmsr.presto.ffi.hadont.util.UTF8ByteArrayUtils;
        ...
        extends OutputReader<Text, Text>
{
            ...
            throws IOException
    {
        ...
        lineReader = new LineReader((InputStream) clientIn);
        key = new Text();
        value = new Text();
        line = new Text();
    }
