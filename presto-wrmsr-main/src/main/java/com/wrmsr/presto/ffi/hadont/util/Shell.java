...
public abstract class Shell
{
            ...
            throws IOException
    {
        ...
        if (len > WINDOWS_MAX_SHELL_LENGTH) {
            throw new IOException(String.format(
                    ...
                    Joiner.on("").join(commands).substring(0, 100)));
        }
    }
     ...
     */
    private static File checkHadoopHome()
    ...
    */
     ...
     */
    @VisibleForTesting
    static File checkHadoopHomeInner(String home)
            throws FileNotFoundException
    {
     ...
     */
    private static File getHadoopHomeDir()
            throws FileNotFoundException
    {
     ...
     */
    public static File getWinUtilsFile()
            throws FileNotFoundException
    {
        if (WINUTILS_FAILURE == null) {
