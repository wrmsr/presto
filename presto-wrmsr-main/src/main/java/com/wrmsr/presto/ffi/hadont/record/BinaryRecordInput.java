        ...
        implements RecordInput
{
    ...
    static private class BinaryIndex
            implements Index
    {
        private int nelems;
    ...
    @Override
    public byte readByte(final String tag)
            throws IOException
    {
        return in.readByte();
    }
    ...
    @Override
    public boolean readBool(final String tag)
            throws IOException
    {
    ...
    @Override
    public int readInt(final String tag)
            throws IOException
    {
    ...
    @Override
    public long readLong(final String tag)
            throws IOException
    {
    ...
    @Override
    public double readDouble(final String tag)
            throws IOException
    {
    ...
    @Override
    public String readString(final String tag)
            throws IOException
    {
    ...
    @Override
    public Buffer readBuffer(final String tag)
            throws IOException
    {
    ...
    @Override
    public void startRecord(final String tag)
            throws IOException
    {
        // no-op
    }
    ...
    @Override
    public void endRecord(final String tag)
            throws IOException
    {
        // no-op
    }
    ...
    @Override
    public Index startVector(final String tag)
            throws IOException
    {
    ...
    @Override
    public void endVector(final String tag)
            throws IOException
    {
        // no-op
    }
    ...
    @Override
    public Index startMap(final String tag)
            throws IOException
    {
        return new BinaryIndex(readInt(tag));
    }
    ...
    @Override
    public void endMap(final String tag)
            throws IOException
    {
        // no-op
    }
