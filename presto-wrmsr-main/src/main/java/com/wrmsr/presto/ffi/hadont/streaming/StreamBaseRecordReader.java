...
//import com.wrmsr.presto.ffi.hadont.fs.FSDataInputStream;
//import com.wrmsr.presto.ffi.hadont.io.Text;
//import com.wrmsr.presto.ffi.hadont.mapred.FileSplit;
...
//     */
//    public abstract boolean next(Text key, Text value)
//            throws IOException;
//
...
//            throws IOException;
//
//    void numRecStats(byte[] record, int start, int len)
//            throws IOException
//    {
//        numRec_++;
