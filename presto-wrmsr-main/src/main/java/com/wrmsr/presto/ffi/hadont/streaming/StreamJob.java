...
//import com.wrmsr.presto.ffi.hadont.conf.Configuration;
//import com.wrmsr.presto.ffi.hadont.fs.FileAlreadyExistsException;
//import com.wrmsr.presto.ffi.hadont.fs.FileSystem;
//import com.wrmsr.presto.ffi.hadont.fs.FileUtil;
//import com.wrmsr.presto.ffi.hadont.fs.Path;
//import com.wrmsr.presto.ffi.hadont.mapred.FileInputFormat;
//import com.wrmsr.presto.ffi.hadont.mapred.FileOutputFormat;
//import com.wrmsr.presto.ffi.hadont.mapred.InvalidJobConfException;
//import com.wrmsr.presto.ffi.hadont.mapred.JobClient;
//import com.wrmsr.presto.ffi.hadont.mapred.JobConf;
//import com.wrmsr.presto.ffi.hadont.mapred.JobID;
//import com.wrmsr.presto.ffi.hadont.mapred.KeyValueTextInputFormat;
//import com.wrmsr.presto.ffi.hadont.mapred.RunningJob;
//import com.wrmsr.presto.ffi.hadont.mapred.SequenceFileAsTextInputFormat;
//import com.wrmsr.presto.ffi.hadont.mapred.SequenceFileInputFormat;
//import com.wrmsr.presto.ffi.hadont.mapred.TextInputFormat;
//import com.wrmsr.presto.ffi.hadont.mapred.TextOutputFormat;
//import com.wrmsr.presto.ffi.hadont.mapred.lib.LazyOutputFormat;
//import com.wrmsr.presto.ffi.hadont.mapred.lib.aggregate.ValueAggregatorCombiner;
//import com.wrmsr.presto.ffi.hadont.mapred.lib.aggregate.ValueAggregatorReducer;
//import com.wrmsr.presto.ffi.hadont.mapreduce.MRConfig;
//import com.wrmsr.presto.ffi.hadont.mapreduce.MRJobConfig;
//import com.wrmsr.presto.ffi.hadont.mapreduce.filecache.DistributedCache;
//import com.wrmsr.presto.ffi.hadont.mapreduce.server.jobtracker.JTConfig;
//import com.wrmsr.presto.ffi.hadont.streaming.io.IdentifierResolver;
//import com.wrmsr.presto.ffi.hadont.streaming.io.InputWriter;
//import com.wrmsr.presto.ffi.hadont.streaming.io.OutputReader;
//import com.wrmsr.presto.ffi.hadont.util.GenericOptionsParser;
//import com.wrmsr.presto.ffi.hadont.util.ReflectionUtils;
//import com.wrmsr.presto.ffi.hadont.util.RunJar;
//import com.wrmsr.presto.ffi.hadont.util.StringUtils;
//import com.wrmsr.presto.ffi.hadont.util.Tool;
//
//import java.io.File;
...
//     * @throws IOException
//     */
//    static public JobConf createJob(String[] argv)
//            throws IOException
//    {
...
//    }
//
//    String unqualifyIfLocalPath(String cmd)
//            throws IOException
//    {
//        if (cmd == null) {
//            //
...
//                    .getName())
//                    || inputFormatSpec_
//                    .equals(com.wrmsr.presto.ffi.hadont.mapred.SequenceFileInputFormat.class
//                            .getCanonicalName())
//                    || inputFormatSpec_
//                    .equals(com.wrmsr.presto.ffi.hadont.mapred.SequenceFileInputFormat.class.getSimpleName())) {
//                if (inReaderSpec_ == null) {
