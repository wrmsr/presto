        ...
        extends SqlOperator
{
    ...
    public EncodedToVarbinaryCast(TypeCodec typeCodec)
    {
        super(CAST, ImmutableList.of(typeVariable("T")), ImmutableList.of(), parseTypeSignature("varbinary"), ImmutableList.of(parseTypeSignature(typeCodec.getName() + "<T>")));
