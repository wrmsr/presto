        ...
        implements Module
{
    ...
    {
        bindRowDecoder(binder, JsonRowCodec.class);

        bindFieldDecoder(binder, JsonFieldCodec.class);
        bindFieldDecoder(binder, ISO8601JsonFieldCodec.class);
        bindFieldDecoder(binder, RFC2822JsonFieldCodec.class);
        bindFieldDecoder(binder, SecondsSinceEpochJsonFieldCodec.class);
        bindFieldDecoder(binder, MillisecondsSinceEpochJsonFieldCodec.class);
        bindFieldDecoder(binder, CustomDateTimeJsonFieldCodec.class);
    }
}
