 ...
 */
public class CsvFieldCodec
        implements FieldCodec<String>
{
    @Override
    ...
    @Override
    public FieldValueProvider decode(final String value, final CodecColumnHandle columnHandle)
    {
