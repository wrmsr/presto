 ...
 */
public final class CodecColumnHandle
        implements ColumnHandle, Comparable<CodecColumnHandle>
{
    ...
    public boolean equals(Object obj)
    {
        ...
        CodecColumnHandle other = (CodecColumnHandle) obj;
    ...
    @Override
    public int compareTo(CodecColumnHandle otherHandle)
    {
