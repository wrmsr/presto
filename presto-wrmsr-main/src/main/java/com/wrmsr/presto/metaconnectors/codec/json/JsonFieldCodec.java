 ...
 */
public class JsonFieldCodec
        implements FieldCodec<JsonNode>
{
    @Override
            ...
            extends FieldValueProvider
    {
        ...
        public JsonValueProvider(JsonNode value, CodecColumnHandle columnHandle)
        {
            this.value = value;
    ...
    {
        protected DateTimeJsonValueProvider(JsonNode value, CodecColumnHandle columnHandle)
        {
