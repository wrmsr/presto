...
/**
 * Guice module for the 'dummy' decoder. See {@link DummyRowCodec} for an explanation.
 */
        ...
        implements Module
{
    ...
    {
        bindRowDecoder(binder, DummyRowCodec.class);

        bindFieldDecoder(binder, DummyFieldCodec.class);
    }
}
