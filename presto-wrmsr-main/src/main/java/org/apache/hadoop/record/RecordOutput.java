...
public interface RecordOutput
{
     ...
     * @throws IOException Indicates error in serialization
     */
    public void writeBool(boolean b, String tag)
            throws IOException;
     ...
     * @throws IOException Indicates error in serialization
     */
    public void startVector(ArrayList v, String tag)
            throws IOException;
     ...
     * @throws IOException Indicates error in serialization
     */
    public void endVector(ArrayList v, String tag)
            throws IOException;
     ...
     * @throws IOException Indicates error in serialization
     */
    public void startMap(TreeMap m, String tag)
            throws IOException;
     ...
     * @throws IOException Indicates error in serialization
     */
    public void endMap(TreeMap m, String tag)
            throws IOException;
}
