...
public class ExtendedMySqlConfig
{
    ...
    public ExtendedMySqlConfig setAutoReconnect(boolean autoReconnect)
    {
    ...
    public ExtendedMySqlConfig setMaxReconnects(int maxReconnects)
    {
    ...
    public ExtendedMySqlConfig setConnectionTimeout(Duration connectionTimeout)
    {
