 ...
 */
public class RawFieldCodec
        implements FieldCodec<byte[]>
{
    ...
    @Override
    public FieldValueProvider decode(byte[] value, CodecColumnHandle columnHandle)
    {
            ...
            extends FieldValueProvider
    {
        ...
        protected final CodecColumnHandle columnHandle;
        protected final FieldType fieldType;
        protected final int size;

        public RawValueProvider(ByteBuffer value, CodecColumnHandle columnHandle, FieldType fieldType)
        {
        ...
        @Override
        public final boolean accept(CodecColumnHandle columnHandle)
        {
