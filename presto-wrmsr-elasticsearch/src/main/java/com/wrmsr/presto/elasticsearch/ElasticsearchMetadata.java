        ...
        extends ReadOnlyConnectorMetadata
{
    ...
    @Inject
    public ElasticsearchMetadata(ElasticsearchConnectorId connectorId, ElasticsearchClient exampleClient)
    {
    ...
    public ElasticsearchTableHandle getTableHandle(ConnectorSession session, SchemaTableName tableName)
    {
        ...
        ElasticsearchTable table = exampleClient.getTable(tableName.getSchemaName(), tableName.getTableName());
        if (table == null) {
            return null;
        }
    ...
    {
        ElasticsearchTableHandle exampleTableHandle = checkType(table, ElasticsearchTableHandle.class, "table");
