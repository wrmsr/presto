...
{
    private final ElasticsearchTable exampleTable = new ElasticsearchTable("tableName",
            ImmutableList.of(new ElasticsearchColumn("a", VARCHAR), new ElasticsearchColumn("b", BIGINT)),
            ...
            throws Exception
    {
        ...
        ElasticsearchTable exampleTableCopy = MetadataUtil.TABLE_CODEC.fromJson(json);
