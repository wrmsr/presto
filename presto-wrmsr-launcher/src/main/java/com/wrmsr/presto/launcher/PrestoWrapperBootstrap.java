...
public class PrestoWrapperBootstrap
{
    ...
    {
        Repositories.setupClassLoaderForModule(PrestoWrapperBootstrap.class.getClassLoader(), "presto-wrmsr-launcher");
        Class<?> cls = Class.forName("com.wrmsr.presto.launcher.PrestoWrapperMain");
