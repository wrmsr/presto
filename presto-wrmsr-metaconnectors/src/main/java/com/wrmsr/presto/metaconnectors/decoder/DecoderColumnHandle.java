...
/**
 * Decoder specific connector column handle.
 */
public final class DecoderColumnHandle
        implements ColumnHandle, Comparable<DecoderColumnHandle>
{
    ...
    public boolean equals(Object obj)
    {
        ...
        DecoderColumnHandle other = (DecoderColumnHandle) obj;
    ...
    @Override
    public int compareTo(DecoderColumnHandle otherHandle)
    {
