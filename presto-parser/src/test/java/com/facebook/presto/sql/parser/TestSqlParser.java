        ...
        assertStatement("SELECT * FROM table1 WINDOW a AS ()",
                new Query(
                        ...
                        new QuerySpecification(
                                ...
                                Optional.empty(),
                                Optional.empty(),
                                ImmutableList.of(new WindowDefinition("a", new WindowSpecification(Optional.empty(), ImmutableList.of(), ImmutableList.of(), Optional.empty()))),
                                ImmutableList.of(),
                                Optional.empty()),
                        ImmutableList.of(),
                        Optional.empty(),
        ...
        assertStatement("SELECT * FROM table1 WINDOW a AS (PARTITION BY 1), b AS (ORDER BY 2 ASC NULLS LAST)",
                new Query(
                        ...
                        new QuerySpecification(
                                ...
                                Optional.empty(),
                                ImmutableList.of(
                                        new WindowDefinition("a", new WindowSpecification(Optional.empty(), ImmutableList.of(new LongLiteral("1")), ImmutableList.of(), Optional.empty())),
                                        new WindowDefinition("b", new WindowSpecification(Optional.empty(), ImmutableList.of(), ImmutableList.of(new SortItem(new LongLiteral("2"), SortItem.Ordering.ASCENDING, SortItem.NullOrdering.LAST)), Optional.empty()))),
                                ImmutableList.of(),
                                Optional.empty()),
                        ImmutableList.of(),
                        Optional.empty(),
