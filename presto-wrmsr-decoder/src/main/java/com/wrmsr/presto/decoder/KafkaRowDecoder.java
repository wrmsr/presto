...
/**
 * Implementations decode a Kafka message from bytes and add field value providers for all decodable columns.
 */
public interface KafkaRowDecoder
{
     ...
     *
     * @param data The row data (Kafka message) to decode.
