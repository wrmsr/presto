...
public class ExampleScheduler implements Scheduler
{
    ...
    /** Logger. */
    private static final Logger logger = Logger.getLogger(ExampleScheduler.class.getName());
    ...
    {
        logger.info(MessageFormat.format("registered() master={}:{}, framework={}", masterInfo.getIp(), masterInfo.getPort(), frameworkID));
    }
    ...
    public void resourceOffers(SchedulerDriver schedulerDriver, List<Protos.Offer> offers)
    {
        ...
        logger.info(MessageFormat.format("resourceOffers() with {} offers", offers.size()));
        ...
        for (Protos.Offer offer : offers) {
            ...
            if (runningInstances.size() + pendingInstances.size() < desiredInstances) {
                ...
                logger.info(MessageFormat.format("Launching task {}", taskId.getValue()));
    ...
    public void statusUpdate(SchedulerDriver driver, Protos.TaskStatus taskStatus)
    {
        ...
        logger.info(MessageFormat.format("statusUpdate() task {} is in state {}",
        ...
        logger.info(MessageFormat.format("Number of instances: pending={}, running={}",
    ...
    {
        logger.severe(MessageFormat.format("error() {}", s));
    }
}
